...
import aboutPic from "../assets/img/about/full-stack-developer.png";
      ...
      <div className="container">
        <div className="about_inner">
          ...
          <div className="right">
            ...
            <div className="text">
              <p>
                My name is Abby Zhang. I&apos;m a Web Developer, and I&apos;m very passionate and
                dedicated to my work.
              </p>
              <p>
                With 9 years experience as a professional Web developer, I have acquired the
                different skills and knowledge necessary to make your project a success. I enjoy
            ...
            <div className="social-connect">
              ...
              <a href="https://github.com/aiyazkhorajia" target="_blank" rel="noreferrer">
